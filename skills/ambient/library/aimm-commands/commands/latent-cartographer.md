...
- `/aimm:latent-cartographer [your question]` — standard traversal (all 6 phases)
- `/lsc [your question]` — shorthand alias
- `/lsc-lite [your question]` — quick scan (phases 1, 2, 6 only)
- `/lsc-deep [your question]` — deep bore (all 6 + iteration on the output)
- `/cartograph [your question]` — alternate alias
