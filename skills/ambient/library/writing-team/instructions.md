...
Read and follow `${CLAUDE_PLUGIN_ROOT}/skills/ambient/library/researcher/instructions.md`
against the brief. Have it write `RESEARCH-<slug>.md`. Carry the dossier and its
open-questions list forward.

### 3. Draft

Read and follow `${CLAUDE_PLUGIN_ROOT}/skills/ambient/library/writer/instructions.md`,
...
Read and follow `${CLAUDE_PLUGIN_ROOT}/skills/ambient/library/editor/instructions.md`
