...
2. Read `${CLAUDE_SKILL_DIR}/library/audit-mcp/scripts/audit-mcp.sh` using the Read tool, then write it to `~/.claude/scripts/audit-mcp.sh`
...
- `${CLAUDE_SKILL_DIR}/library/audit-mcp/scripts/audit-mcp.sh`
