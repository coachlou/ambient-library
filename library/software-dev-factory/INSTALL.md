...
> An Ubuntu window should open by itself. If it doesn't, click Start, type `ubuntu`, and
> open it.
>
> The first time it runs it sets itself up for a couple of minutes, then asks you to create
> a username and password. Use anything you'll remember — this is separate from your
> Windows login. **When you type the password, nothing at all will appear on screen. That's
> normal — it's still working. Type it and press Enter.** It'll ask you to type it a second
> time to confirm.
>
