...
```markdown
## Source domain
<the domain the analogy comes from>

## The analogy
<2–3 sentences stating the analogy plainly>

## Structural mapping
- **[Thesis element A]** maps to **[Source domain element A]** — <one sentence>
...
## Where it breaks
<1–2 sentences naming the limit>

## So what
<1–2 sentences: how this changes the reader's understanding>

## Drafter guidance
<1–2 sentences suggesting deployment>

## Self-evaluation
<see universal format at the bottom of this file>
```

## Emotional Architect output

```markdown
## Reader's entry state
<1 sentence: what the reader feels arriving at this piece>
...
## Arc summary
<2 sentences describing the overall emotional journey>

## Self-evaluation
<see universal format at the bottom of this file>
```

## Compression Agent output

```markdown
## One-sentence distillation
<one sentence — the entire argument>
...
**Pass/Fail:** <pass if all three feel specific and honest>
**If fail — where the softness lives:** <upstream diagnosis>
**Thesis drift check:** <Yes/No/Partially>
...
Every role output includes an additional field at the top, before any other content:

```markdown
## Variant used
<base / variant-name — e.g., "inversion-first" or "base">
```

This allows the orchestrator to log which variant produced each output for fitness tracking.
